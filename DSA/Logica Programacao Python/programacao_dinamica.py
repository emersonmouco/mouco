...
# Aqui  está  a  grande  diferença  da  Programação  Dinâmica,  
# uma  espécie  de  "memória"  para armazenar soluções parciais
cache = {}
...
def divideString(input_string, inicio_index):
    ...
    Esta função recursiva, tenta dividir a 
    substring começando em 'inicio_index' em partições, 
    ou seja, palavras!
    ...
    for i in range(1, len(substring) + 1):
        ...
        if min_cost is None or current_cost < min_cost:
            ...
            if current_string and rest_string:
                ...
                #  Adicionamos  um  custo  ao  espaço  em  branco  para  evitar  
                # a  divisão  de  palavras desconhecidas em pequenos pedaços
                current_cost += 1
