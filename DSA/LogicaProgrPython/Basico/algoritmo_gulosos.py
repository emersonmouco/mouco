...
#  Algoritmo  guloso  que  busca  a  melhor  
# combinação  de  alimentos  para  uma  dieta  de  1000 calorias.
...
class Alimentos(object):
    ...
    # Método para obter o custo (1 dividido pelo número 
    # de calorias, calculado mais abaixo. Aqui retornamos apenas as calorias)
    def getCusto(self):
...
#  Função  que  gera  o  melhor  cardápio  pelo  valor  individual  
# dos  alimentos  e  pelo  custo  dos alimentos
def geraCardapio(alimentos, totCalorias):
    ...
    print('\n Usandoo  algoritmo  guloso  para  buscar  o  melhor  menu  pelo  custo  dos  alimentos para', totCalorias,'calorias')
