programa {
  ...
  funcao cadastro(){
    ...
    escreva("\n###########\n")
    escreva("# Cadastro RH SENACTL Engenharia #\n")
    escreva("\n###########\n")
    escreva("Nome: \n")
    leia(nome)
    ...
    // verificação da cidade de atuação
    se(cidade_atuacao == 1){
    ...
    // verifição em relação ao número de filhos
    // verificando o quanto o funcionário irá receber de auxilio creche
    ...
    // verificando o quanto irá receceber de vale transporte
    ...
    // verificando se irá receber plano de saúde
    se(plano_saude == 1){
      Plano_de_Saude = 400
    }senao{
      Plano_de_Saude = 0
