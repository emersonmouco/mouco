programa {
  funcao inicio() {
    ...
    escreva("\nDigite qualquer tecla para prosseguir: ")
    leia(a)
    escreva("\nDigite o nome do funcionário (somente o primeiro nome): ")
    leia(nome)
    escreva("\nEscolha a cidade de atuação (1 - Agua Escura, 2 - Campo Pequeno, 3 - Três Rios e Meio): ")
    leia(cidade)
    ...
    escreva("\nVale Transporte? (1 - Sim, 2 - Não): ")
    leia(vale_transporte)
    escreva("\nEscolha o cargo (1 - Engenheiro, 2 - Mestre de Obra, 3 - Pedreiro): ")
    leia(cargo)
    limpa()
